...
def build_args():
    ...
    parser.add_argument("--max_epoch_f", type=int, default=200)
    parser.add_argument("--lr_f", type=float, default=0.0005, help="learning rate for evaluation")
    ...
    parser.add_argument('--seed_e', type=int, default=2022, help='Random seed for model and dataset. (default: 2022)')
    ...
    parser.add_argument('--encoder_channels', type=int, default=3000,
    ...
    parser.add_argument('--decoder_channels', type=int, default=512, help='Channels of decoder layers. (default: 128)')
    ...
    parser.add_argument('--alpha', type=float, default=0.7, help='loss weight for LOSS. (default: 0.5)')

    parser.add_argument('--lr_e', type=float, default=0.00005, help='Learning rate for training. (default: 0.01)')
    ...
    parser.add_argument('--p', type=float, default=0.3, help='Mask ratio or sample ratio for MaskEdge')
    parser.add_argument('--q', type=float, default=0.4, help='Mask ratio or sample ratio for MaskNode')
